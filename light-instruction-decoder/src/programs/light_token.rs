...
pub enum CTokenInstruction {
    ...
    #[instruction_decoder(
        ...
        account_names_resolver_from_params = crate::programs::light_token::resolve_transfer2_account_names,
        pretty_formatter = crate::programs::light_token::format_transfer2
    )]
    Transfer2,
